namespace Cordonez.Raytracer
{
	...
	public class _8_Metal : MonoBehaviour
	{
		public int Width;
		public int Height;
		...
		private void Start()
		{
			...
			m_worldElements.Add(new Sphere(new Vector3(0, 0, -1), 0.5f, new Lambertian(new Vector3(0.8f, 0.3f, 0.3f))));
			...
			m_worldElements.Add(new Sphere(new Vector3(-1, 0, -1), 0.5f, new Metal(new Vector3(0.8f, 0.8f, 0.8f), 1)));
			Draw();
		}
